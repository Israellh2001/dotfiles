...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        local wallpaper = '/home/israellh/Pictures/Saved Pictures/pexels-eberhard-grossgasteiger-1292115.jpg'
	-- beautiful.wallpaper
...
globalkeys = gears.table.join(
    ...
    awful.key({"Mod5" },   "r",    
		...
		awful.util.spawn("dmenu_run -c")
	end,
              {description = "run dmenu", group = "launcher"}),
    awful.key({"Mod5" },   "e",     
         function ()
                 awful.util.spawn("sh /home/israellh/Code/apps.sh")
         end,
    ...
    awful.key({                   }, "XF86AudioMute",        function() awful.spawn("amixer set Master toggle" )	end),
        awful.key({ }, "XF86MonBrightnessDown", function ()
	        awful.spawn("light -U 10") end),
	awful.key({ }, "XF86MonBrightnessUp", function ()
	        awful.spawn("light -A 10") end)
...
clientkeys = gears.table.join(
    ...
    awful.key({ "Mod5"    }, "q",      function (c) c:kill()                         end,
